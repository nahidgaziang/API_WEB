-- Complete Database Reset and Reseed for LMS
-- This script clears all existing data and reseeds with plain text passwords/secrets
...
-- Show summary
SELECT 'Database reset and reseeded successfully!' AS message;
...
SELECT 'Verify passwords are in plain text:' AS info;
SELECT username, password, role FROM users LIMIT 3;
