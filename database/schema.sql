-- LMS System Database Schema
-- MySQL Database for Learning Management System

-- Create database (if needed)
CREATE DATABASE IF NOT EXISTS lms_system;
USE lms_system;

-- Table 1: Users (Learners, Instructors, LMS Admin)
...
CREATE TABLE bank_accounts (
    ...
    secret VARCHAR(255) NOT NULL COMMENT 'bcrypt hashed',
...
CREATE TABLE courses (
    ...
    upload_payment DECIMAL(10,2) NOT NULL COMMENT 'Lump sum paid to instructor for uploading',
...
CREATE TABLE course_materials (
    ...
    content TEXT COMMENT 'For text content or MCQ JSON',
    file_url VARCHAR(500) COMMENT 'For audio/video files',
...
CREATE TABLE transactions (
    ...
    reference_id INT COMMENT 'course_id or enrollment_id',
