...
export interface EnrollmentAttributes {
    ...
    status?: 'pending' | 'enrolled' | 'in_progress' | 'completed';
}
class Enrollment extends Model<EnrollmentAttributes> implements EnrollmentAttributes {
    ...
    public status!: 'pending' | 'enrolled' | 'in_progress' | 'completed';
}
Enrollment.init(
    {
        id: {
        ...
        status: {
            type: DataTypes.ENUM('pending', 'enrolled', 'in_progress', 'completed'),
